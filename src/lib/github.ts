...
const FALLBACK_REPOS: GitHubRepo[] = [
  ...
  },
  {
    ...
    description:
      "AntNest 是一个采用蚁后 / 工蚁架构（或者蜂后/工蜂）的 AI 编程助手。蚁后（本体）：只负责思考、规划、决策；工蚁（复制体）：在隔离的临时目录里执行命令，干完活就被杀掉。",
    language: "Python",
    stargazers_count: 1,
    forks_count: 0,
  ...
  },
  {
    id: 681927405,
    name: "llxpy",
    full_name: "llxpy/llxpy",
    html_url: "https://github.com/llxpy/llxpy",
    ...
    updated_at: "2023-08-31T16:09:20Z",
    pushed_at: "2023-08-23T04:18:02Z",
